...
<style scoped>
.header-buttons{display:flex;justify-content:flex-end;gap:10px;position:relative}
.how-to-use-button{padding:10px 20px;background-color:#4CAF50;color:white;border:none;border-radius:5px;cursor:pointer}
.how-to-use-button:hover{background-color:#45a049}
.logout-button{padding:10px 20px;background-color:#ff5c5c;color:white;border:none;border-radius:5px;cursor:pointer}
.logout-button:hover{background-color:#e04e4e}
.interview-container{display:flex;flex-direction:column;justify-content:flex-start;max-width:1200px;width:100%;height:90vh;margin:0 auto;padding:10px;box-sizing:border-box;background-color:#f5f7fa}
:deep(p){margin:2px 0}
.tabs{display:flex;border-bottom:2px solid #e5e7eb;margin-bottom:20px}
.tab{flex:1;padding:15px 20px;background:none;border:none;border-bottom:2px solid transparent;font-size:1.2em;cursor:pointer;transition:border-bottom .3s,background-color .3s}
.tab:hover{background-color:#f0f4f8}
.tab.active{border-bottom:2px solid #0066cc;font-weight:bold;color:#0066cc}
.tab-content{flex-grow:1;display:flex;flex-direction:column}
.interview{display:flex;flex-direction:column;background-color:#fff;border-radius:10px;box-shadow:0 4px 6px rgba(0,0,0,0.1);overflow:hidden}
.interview header{background-color:#0066cc;padding:15px 20px;color:white;text-align:center}
.interview header h2{margin:0;font-size:1.5em}
.interview-area{display:flex;flex-direction:column;flex-grow:1;padding:10px;height:calc(90vh - 135px);box-sizing:border-box}
.output{flex-grow:1;overflow-y:auto;margin-bottom:20px;padding:15px;background-color:#f9fafb;border:1px solid #e5e7eb;border-radius:8px}
.conversation-unit{display:flex;flex-direction:column;margin-bottom:15px}
.conversation-unit.system{align-items:flex-start}
.conversation-unit.user{align-items:flex-end}
.message{padding:10px 15px;border-radius:20px;max-width:85%;word-wrap:break-word;position:relative;margin-bottom:5px}
.message.system{background-color:#e0f7fa;color:#0066cc;text-align:left}
.message.user{background-color:#dcf8c6;color:#006600;text-align:right}
.input-area{display:flex;align-items:center;gap:10px;margin-bottom:10px}
.message-form{display:flex;justify-content:center;align-items:center;width:100%}
.message-form textarea{width:calc(100% - 70px);padding:12px 15px;font-size:16px;border:1px solid #ccc;border-radius:25px;resize:none;outline:none;transition:border-color .3s;margin-right:10px}
.message-form textarea:focus{border-color:#0066cc;box-shadow:0 0 5px rgba(0,102,204,0.5)}
.send-button{display:flex;align-items:center;justify-content:center;padding:10px;font-size:16px;background-color:#0066cc;color:white;border:none;border-radius:25px;cursor:pointer;transition:background-color .3s;width:50px;height:50px}
.send-button:hover{background-color:#005bb5}
.icon-send{width:20px;height:20px}
...
.loading-spinner{display:flex;justify-content:center;align-items:center;padding:10px}
.spinner{border:4px solid rgba(0,0,0,0.1);width:36px;height:36px;border-radius:50%;border-left-color:#0066cc;animation:spin 1s linear infinite}
@keyframes spin{to{transform:rotate(360deg)}}
.language-select{margin-top:10px;padding:5px;font-size:16px;border-radius:5px;border:1px solid #ccc;outline:none}
</style>
